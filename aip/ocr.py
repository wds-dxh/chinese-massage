...
class AipOcr(AipBase):
    ...
    # 银行卡回单
    __bank_receipt_newUrl = "https://aip.baidubce.com/rest/2.0/ocr/v1/bank_receipt_new"

    __marriage_certificate = "https://aip.baidubce.com/rest/2.0/ocr/v1/marriage_certificate"

    __hk_macau_taiwan_exitentrypermit = "https://aip.baidubce.com/rest/2.0/ocr/v1/hk_macau_taiwan_exitentrypermit"
    ...
    def bank_receipt_new(self, image, options=None):
        """
            银行回单识别
        """
        options = options or {}
        ...
        return self._request(self.__bank_receipt_newUrl, data)

    def bank_receipt_newUrl(self, url, options=None):
        """
            银行回单识别_url图片方式
        """
        options = options or {}
    ...
    def bank_receipt_newPdf(self, pdf_file, options=None):
        """
            银行回单识别_pdf文件方式
        """
        options = options or {}
    ...
    def marriage_certificateUrl(self, url, options=None):
        """
            结婚证识别_url图片方式
            https://ai.baidu.com/ai-doc/OCR/Klg67mfkc
        """
    ...
    def marriage_certificatePdf(self, pdf_file, options=None):
        """
            结婚证识别_pdf文件方式
            https://ai.baidu.com/ai-doc/OCR/Klg67mfkc
        """
    ...
    def hk_macau_taiwan_exitentrypermit(self, image, exitentrypermit_type, options=None):
        """
            港澳台证件识别
        ...
        return self._request(self.__hk_macau_taiwan_exitentrypermit, data)

    def hk_macau_taiwan_exitentrypermitUrl(self, url, exitentrypermit_type, options=None):
        """
            港澳台证件识别_url图片方式
            https://ai.baidu.com/ai-doc/OCR/Tlg6859ns
        """
    ...
    def hk_macau_taiwan_exitentrypermitPdf(self, pdf_file, exitentrypermit_type, options=None):
        """
            港澳台证件识别_pdf文件方式
            https://ai.baidu.com/ai-doc/OCR/Tlg6859ns
        """
