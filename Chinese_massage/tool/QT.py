...
class TextDisplayWindow(QMainWindow):
    ...
    def set_text_function(self, get_text_function):
        self.get_text_function = get_text_function

    def set_timer_interval(self, interval):
        self.timer_interval = interval

    def start_text_timer(self):
...
def display_text_window(get_text_function, font_size=20, timer_interval=2000):
